...
def euclidean_distance(x1, y1, x2, y2):
    return ((x2 - x1) + (y2 - y1))
# Enter slide name 
folder_name="400_HCM_Microscope_data_check"
lis=["3"]
for i in range (48):
   #if i == 26: 
    i=i+1
...
# Create an empty DataFrame with defined column names
    ...
    #data_bb = data_bb.append(my_dataframe, ignore_index=True)
    #print(data_bb.head())
                                    ...
                                    # print("_____________________after________________________")
                                        ...
                                        if b==0:
                                            ...
                                            if k==10:
                                                ...
                                                cv2.imwrite(os.path.join(folder_name,slide_number,f"{slide_number}_{new_image_name}_{new_image_name2}_{new_iamge_resolution}_{new_iamge_lukemi_type}.png"), cropped_image)
                                                width_image, height_image,_=cropped_image.shape
                                                bb_slide2['width']= width_image
                                                bb_slide2['height']= height_image
                                                dfs.append(bb_slide2)
                                        ...
                                        if new_large_slide_name == large_slide_name and score < match_area_percentage:
                                            ...
                                            new_image_name2= large_slide_name.split("_")[1]
                                            ...
                                            new_image_name6= large_slide_name.split("_")[1]
                                            bb_slide['Name'] = f"{slide_number}_{new_image_name1}_{new_image_name6}_{new_iamge_resolution1}_{new_iamge_lukemi_type1}"
    ...
    dfs.append(bb_slide2)
    bb_slide2['width']= width_image
    bb_slide2['height']= height_image                              # print("No good match found. Image not saved.")
