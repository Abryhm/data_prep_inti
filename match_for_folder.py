    ...
    if small_image_res== small_image:
        ...
        for large_slide_name in unique_slide_names:
            ...
            if large_image_res == large_image:
                ...
                if e_distance < 0.5 and e_distance > -0.5:
                #if e_distance == 0:
                    ...
                    # Match descriptors
                    if descriptors_large is not None and descriptors_small is not None:
                        ...
                        if match_area_percentage > match_area_threshold:
                            ...
                            create_folder= f"{small_image}_to_{large_image}_matching_MC_aa"
