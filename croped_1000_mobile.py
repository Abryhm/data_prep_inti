...
def euclidean_distance(x1, y1, x2, y2):
    return ((x2 - x1) + (y2 - y1))
# Enter slide name 
folder_name="1000_HCM_Mobile_data"
...
for i in range (48):
   if i == 39:  
    ...
    data_bb = pd.read_excel( os.path.join('1000_HCM_MicroscopeData/Annotation/',f'{slide_number}_data.xlsx') ) # Replace with the actual file path
                ...
                if small_image_res== small_image:
                    ...
                    for large_slide_name in unique_slide_names:
                        ...
                        if large_image_res == large_image:
                            ...
                            if slide_anme[0] == slide_anme_small[0]:
                                ...
                                print(os.path.join(large_folder,"Mobile_"+slide_anme[0]+".png"))
                                print(os.path.join(small_folder,slide_anme_small[0]+".png" ))
                                  ...
                                  #  print('coordinates:', coordinates)
                                   ...
                                   # print('coordinates:', coordinates)
                                    ...
                                    if (len(coordinates)!=0):
                                        ...
                                        #print('Transformed Coordinates:',transformed_coordinates_int)
                                        ...
                                        bb_slide['X2_cord'] = transformed_coordinates_int[:, 2] - x
                                        bb_slide['Y2_cord'] = transformed_coordinates_int[:, 3] - y 
                                        #print(transformed_coordinates_int[:, 0]-x)
                                       # print(bb_slide['X1_cord'])
                                        ...
                                        #print("new_image_name1:", new_image_name1)
                                        #print("new_iamge_resolution1:", new_iamge_resolution1)
                                        #print("new_iamge_lukemi_type1:", new_iamge_lukemi_type1)

                                        #print(bb_slide['Name'])
                                        dfs.append(bb_slide)
                                        #print(dfs.append(bb_slide))
                                        ...
                                        if b==0:
                                            ...
                                            if k==10:
                                               # print(cropped_image.shape)
                                                #print('score:',score)
                                                #print('Match Area:',match_area_percentage)
                                                #print('new_large_slide_name', new_large_slide_name)
                                                #print('large_slide_name',large_slide_name)
    ...
    output_filename = f'{folder_name}/Annotation/{slide_number}_mobile_data.xlsx'  # Change the filename as needed
